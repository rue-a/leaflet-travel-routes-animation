        ...
        function (t, i, e) {
            ...
            const a = n.a.Class.extend({
                ...
                l = n.a.Class.extend({
                    ...
                    targetOptions: { useImg: !1, imgUrl: "assets/ship.png", showText: !1, width: 8, height: 18, color: "#00f", fillColor: "#9FD12D" },
                ...
                _ = n.a.Class.extend({
                    includes: n.a.Mixin.Events,
                    initialize: function (t, i, e = {}) {
                        let s = { trackPointOptions: e.trackPointOptions, trackLineOptions: e.trackLineOptions, targetOptions: e.targetOptions, toolTipOptions: e.toolTipOptions };
