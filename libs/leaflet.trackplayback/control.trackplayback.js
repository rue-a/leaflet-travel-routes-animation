    ...
    return (function (t) {
        ...
        function (t, e, i) {
            ...
            const o = a.a.Control.extend({
                options: { position: "topright", showOptions: !0, showInfo: !0, showSlider: !0, autoPlay: !1 },
                initialize: function (t, e) {
                    a.a.Control.prototype.initialize.call(this, e), (this.trackPlayBack = t), this.trackPlayBack.on("tick", this._tickCallback, this);
                },
                onAdd: function (t) {
                    return this._initContainer(), this._container;
                },
                onRemove: function (t) {
                    this.trackPlayBack.dispose(), this.trackPlayBack.off("tick", this._tickCallback, this);
                },
                ...
                _initContainer: function () {
                    return (
                        (this._container = a.a.DomUtil.create("div", "leaflet-control-playback")),
                ...
                _createButton: function (t, e, i, n) {
                    ...
                    return (o.href = "#"), (o.title = t), o.setAttribute("role", "button"), o.setAttribute("aria-label", t), a.a.DomEvent.disableClickPropagation(o), a.a.DomEvent.on(o, "click", n, this), o;
                },
                ...
                _createSlider: function (t, e, i) {
                    ...
                    return (
                        ...
                        a.a.DomEvent.on(n, "click mousedown dbclick", a.a.DomEvent.stopPropagation).on(n, "click", a.a.DomEvent.preventDefault).on(n, "change", i, this).on(n, "mousemove", i, this),
                        n
                    );
                },
                _showTrackPoint(t) {
                ...
                _showTrackLine(t) {
                    t.target.checked ? this.trackPlayBack.showTrackLine() : this.trackPlayBack.hideTrackLine();
                },
                _play: function () {
                    a.a.DomUtil.hasClass(this._playBtn, "btn-stop")
                        ? (a.a.DomUtil.removeClass(this._playBtn, "btn-stop"), a.a.DomUtil.addClass(this._playBtn, "btn-start"), this._playBtn.setAttribute("title", "stop"), this.trackPlayBack.start())
                        : (a.a.DomUtil.removeClass(this._playBtn, "btn-start"), a.a.DomUtil.addClass(this._playBtn, "btn-stop"), this._playBtn.setAttribute("title", "play"), this.trackPlayBack.stop());
                },
                _restart: function () {
                ...
                _close: function () {
                    return a.a.DomUtil.remove(this._container), this.onRemove && this.onRemove(this._map), this;
                },
